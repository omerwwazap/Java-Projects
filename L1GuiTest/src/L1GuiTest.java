 ...
 * @author Levent
 */
public class L1GuiTest extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(L1GuiTest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
